...
public abstract class AbstractGRASP<E> {
    ...
    // flag that indicates whether the first-improving should be used
    protected boolean firstImproving;

    //Creates the Candidate List, a list of candidate elements that can enter a solution
    ...
    /**
     * Constructor for the AbstractGRASP class. First-improving false.
     *
     * @param objFunction
    ...
    /**
     * Constructor for the AbstractGRASP class. First-improving difined as
     * parameter.
     *
     * @param objFunction
     *                       The objective function being minimized.
