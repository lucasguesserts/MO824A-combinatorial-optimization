...
print(f"number of nodes: {instance.graph.number_of_nodes()}")
print(f"number of edges: {instance.graph.number_of_edges()}")
print(f"weights shape: {instance.weights.shape}")
